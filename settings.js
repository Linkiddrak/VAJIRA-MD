...
global.owner = process.env.OWNER_NUMBER  || '22871255034' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=bBlw3aIR#bsa-jgSiHE013mKEfCQ3yLkcGWiPT42gXTeEeff4fZ0' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "22871255034" : process.env.MODERATORS ,    
